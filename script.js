...
const CONFIG = {
  ...
  LETTER_MESSAGES: [
  'يمكن في حاجات كتير ومواقف كتير حصلت حسستك اني مش بحبك كفايه او اني محسسك انك مدلوقه عليا وانا مش هاممني حاجه بس يعلم ربنا انا ببقي خايف عليكي من الكلام ازاي في المواقف اللي بتحسي فيها بكدا',
  'بس ده مش معناه إني مش بحبك… بالعكس، يمكن بحبك بطريقة مش بعرف أعبّر عنها صح',
  'أنا ساعات بتلغبط أو بسكت بدل ما أقول اللي جوايا، وده بيبان غلط',
  'بس الحقيقة إنك فارقة معايا جدًا، ويمكن أكتر ما انتي متخيلة',
  'ولو في حاجة ضايقتك مني، فأنا بجد آسف عليها',
],
